    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Nota Agregar</h3>
            </div>
            <?= form_open('nota/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="asignatura_id" class="form-control">
								...
								{
									$selected = ($asignatura['id'] == $this->input->post('asignatura_id')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="parcial" value="<?= $this->input->post('parcial'); ?>" class="form-control" id="parcial" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="teoria" value="<?= $this->input->post('teoria'); ?>" class="form-control" id="teoria" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="practica" value="<?= $this->input->post('practica'); ?>" class="form-control" id="practica" />
