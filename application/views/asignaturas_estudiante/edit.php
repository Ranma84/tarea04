    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Asignaturas Estudiante Edit</h3>
            </div>
			<?= form_open('asignaturas_estudiante/edit/'.$asignaturas_estudiante['id']); ?>
			<div class="box-body">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="lugar_id" class="form-control">
								...
								{
									$selected = ($lugare['id'] == $asignaturas_estudiante['lugar_id']) ? ' selected="selected"' : "";
